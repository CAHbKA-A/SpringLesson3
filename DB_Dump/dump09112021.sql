...
--
-- Name: overviews; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.overviews OWNER TO postgres;

--
-- Name: overviews_overview_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.overviews_overview_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.overviews_overview_id_seq OWNER TO postgres;

--
-- Name: overviews_overview_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.overviews_overview_id_seq OWNED BY public.overviews.overview_id;
...
--
-- Name: overviews overview_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.overviews ALTER COLUMN overview_id SET DEFAULT nextval('public.overviews_overview_id_seq'::regclass);
...
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) VALUES (1, '1.0.1', 'init', 'SQL', 'V1.0.1__init.sql', -580044012, 'postgres', '2021-11-07 16:03:48.920892', 466, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) VALUES (2, '1.0.2', 'init', 'SQL', 'V1.0.2__init.sql', -1178891113, 'postgres', '2021-11-07 16:03:49.421258', 463, true);
...
--
-- Data for Name: overviews; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
INSERT INTO public.product_category (id_product, category_id) VALUES (30, 10);
INSERT INTO public.product_category (id_product, category_id) VALUES (30, 11);
...
INSERT INTO public.products (id_product, title_product, cost_product, description_product, imglink_product) VALUES (29, 'Jproduct1', 7123, 'blahbla2h1', 'https://upload.wikimedia.org/wikipedia/commons/8/8e/An-2_Lutsk.jpg');
INSERT INTO public.products (id_product, title_product, cost_product, description_product, imglink_product) VALUES (30, 'Zproduct1', 123, 'blahbla2h1', 'https://upload.wikimedia.org/wikipedia/commons/8/8e/An-2_Lutsk.jpg');
...
--
-- Name: overviews_overview_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.overviews_overview_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.products_id_product_seq', 30, true);
...
--
-- Name: overviews overviews_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.overviews
    ADD CONSTRAINT overviews_pk PRIMARY KEY (overview_id);
...
--
-- Name: overviews_overview_id_uindex; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX overviews_overview_id_uindex ON public.overviews USING btree (overview_id);
